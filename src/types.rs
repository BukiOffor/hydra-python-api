...
impl IopError {
    pub fn message(&self) -> &'static str {
        match self {
            ...
            Self::CouldNotMatchNetwork => "could not match network, args must be [ mainnet, devnet, testnet ] ",
            ...
            IopError::CouldNotGenerateNewAccountFromVault => "could not generate new account from vault",
